<x-layout>
    ...
    <form action="/kematian" method="POST">
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="penduduk_id" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">NIK -
                    Nama</label>
                <select name="penduduk_id" id="penduduk_id"
                    ...
                    @enderror">
                    <option value="" {{ old('penduduk_id') == null ? 'selected' : '' }}>Tidak ada Penduduk</option>
            ...
            <div>
                ...
                <div class="relative max-w-sm">
                    ...
                    <input name="tanggal_kematian" id="datepicker-format" datepicker datepicker-autohide
                        value="{{ old('tanggal_kematian') }}" datepicker-max-date="{{ now()->toDateString() }}"
            ...
            <div class="">
                ...
                <div class="relative">
                    ...
                    <input type="time" id="time" name="waktu_kematian" value="{{ old('waktu_kematian') }}"

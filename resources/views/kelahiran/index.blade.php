        ...
        <table id="data-table">
            ...
            <tbody>
                @foreach ($data_kelahiran as $kelahiran)
                    <tr>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $kelahiran->penduduk->nama }}
                        </td>
                        <td class="font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $kelahiran->penduduk->jenis_kelamin }}
                        </td>

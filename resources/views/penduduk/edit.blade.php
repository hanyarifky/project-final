        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <select name="jenis_kelamin" id="jenis_kelamin"
                    ...
                    <option value="laki-laki"
                        {{ old('jenis_kelamin', $penduduk->jenis_kelamin) == 'laki-laki' ? 'selected' : '' }}>Laki -
                        laki</option>
            ...
            <div>
                ...
                <select name="agama" id="agama" required
                    ...
                    <option value="budha" {{ old('agama', $penduduk->agama) == 'budha' ? 'selected' : '' }}>Budha
                    </option>
                    <option value="katholik" {{ old('agama', $penduduk->agama) == 'katholik' ? 'selected' : '' }}>
                        Katholik</option>
                    <option value="konghucu" {{ old('agama', $penduduk->agama) == 'konghucu' ? 'selected' : '' }}>
                        Konghucu</option>
                    <option value="lainnya" {{ old('agama', $penduduk->agama) == 'lainnya' ? 'selected' : '' }}>Lainnya
                    </option>
                </select>
                @error('agama')
            ...
            <div>
                ...
                <select name="kartu_keluarga_id" id="kartu_keluarga_id"
                    ...
                    @enderror">
                    <option value=""
                        {{ old('kartu_keluarga_id', $penduduk->kartu_keluarga_id) == null ? 'selected' : '' }}>Tidak

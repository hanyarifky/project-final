<x-layout>
    <form method="POST" action="/perpindahan">
        @csrf
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input name="tanggal_pindah" id="datepicker-format-pindah" datepicker datepicker-autohide
                        value="{{ old('tanggal_pindah') }}" datepicker-max-date="{{ now()->toDateString() }}"
            ...
            <div>
                ...
                <input type="text" name="alamat_asal" id="alamat_asal" value="{{ old('alamat_asal') }}" required
            ...
            <div>
                ...
                <input type="text" name="alamat_tujuan" id="alamat_tujuan" value="{{ old('alamat_tujuan') }}" required
            ...
            <div>
                ...
                <input type="text" name="alasan_pindah" id="alasan_pindah" value="{{ old('alasan_pindah') }}" required
            ...
            <div>
                ...
                <select name="status_perpindahan" id="status_perpindahan" required
                    ...
                    <option value="sementara" {{ old('status_perpindahan') == 'sementara' ? 'selected' : '' }}>Sementara</option>
                    <option value="permanen" {{ old('status_perpindahan') == 'permanen' ? 'selected' : '' }}>Permanen</option>
                </select>
